...
// - Printing / clearing at high frequency(ie, in a loop at 60FPS) at the same terminal coordinates may cause some of the characters to skip rendering.adding `std::cout << std::flush; `  the terminal to print all the characters before moving forward.
